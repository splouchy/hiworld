...
let s:cpo_save=&cpo
set cpo&vim
inoremap <silent> <Up> =pumvisible() ? "\<Up>" : "\<C-O>gk"
inoremap <silent> <Down> =pumvisible() ? "\<Down>" : "\<C-O>gj"
cnoremap <C-F4> c
inoremap <C-F4> c
cnoremap <C-Tab> w
inoremap <C-Tab> w
...
nnoremap  gggHG
vnoremap  "+y
onoremap <silent>  :promptfind
vnoremap <silent>  y:promptfind "
nnoremap <silent>  :promptfind
...
cnoremap  gggHG
inoremap  gggHG
cnoremap <silent>  :promptfind
inoremap <silent>  :promptfind
...
set ruler
set runtimepath=~/.vim,/usr/local/share/vim/vimfiles,/usr/local/share/vim/vim81,/usr/local/share/vim/vim81/pack/dist/opt/matchit,/usr/local/share/vim/vimfiles/after,~/.vim/after
set scrolloff=5
...
argglobal
%argdel
$argadd secondgood.file
edit secondgood.file
